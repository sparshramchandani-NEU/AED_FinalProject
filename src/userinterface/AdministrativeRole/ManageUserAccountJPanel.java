...
public class ManageUserAccountJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lblManageUsers.setBackground(new java.awt.Color(255, 153, 153));
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 164, 0)));
        ...
        jPanel2.add(lblUsername, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 240, 100, 21));

        nameSeparator.setForeground(new java.awt.Color(0, 0, 0));
        jPanel2.add(nameSeparator, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 300, 290, 10));

        lblPassword.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        lblPassword.setText("Password");
        jPanel2.add(lblPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 330, 100, 26));

        nameSeparator1.setForeground(new java.awt.Color(0, 0, 0));
        jPanel2.add(nameSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 387, 290, -1));
        ...
        btnCreate.setBackground(new java.awt.Color(255, 164, 0));
        ...
        jPanel2.add(btnCreate, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 460, 110, 30));

        txtUsername.setBackground(new java.awt.Color(242, 242, 242));
        txtUsername.setFont(new java.awt.Font("Arial", 1, 20)); // NOI18N
        txtUsername.setBorder(null);
        jPanel2.add(txtUsername, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 270, 290, 30));

        txtPassword.setBackground(new java.awt.Color(242, 242, 242));
        txtPassword.setFont(new java.awt.Font("Arial", 1, 20)); // NOI18N
        txtPassword.setBorder(null);
        jPanel2.add(txtPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 360, 290, 30));

        add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 140, 470, 510));

        lblEnterprise.setBackground(new java.awt.Color(0, 0, 0));
        lblEnterprise.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        lblEnterprise.setText("Enterprise:");
        add(lblEnterprise, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 200, -1, 30));
        ...
        add(enterpriseNameTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 200, 230, 30));
